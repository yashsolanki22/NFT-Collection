...
// extend this contract to ERC721Enumerable and Ownable
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    // _price is the price of the one Crypto Dev NFT
    uint256 public _price = 0.01 ether;

    // _paused is used to pause the contract in case of an emergency
    bool public _paused;

    // max number of Crypto Devs NFT token
    uint256 public maxTokenIds = 20;

    // this variable will store total number of Ids minted so far
    uint256 public tokenIds;

    // now create Iwhitelist contract Instance
